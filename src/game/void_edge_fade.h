#ifndef ARCANUM_GAME_VOID_EDGE_FADE_H_
#define ARCANUM_GAME_VOID_EDGE_FADE_H_
...
// Offline all-maps structural audit (run with ARCANUM_VOID_FADE_AUDIT=1). Mounts every
// module group, classifies every sector of every map, floods void regions, and
// reports fade edge-case classes to /tmp/void_fade_audit.txt, then exits the process.
